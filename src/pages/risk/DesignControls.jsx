...
export default function DesignControls() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Design Controls (IEC 62304)</h1>
        <p className="text-slate-400">Manage software/medical device design process following IEC 62304 standard</p>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-eqms-border">
                <th className="text-left py-3 px-4 font-semibold text-slate-300">Design ID</th>
            ...
            <tbody>
              <tr className="border-b border-eqms-border hover:bg-eqms-input transition-colors">
                <td colSpan="6" className="py-12 px-4 text-center">
                  ...
                  <p className="text-slate-500">No design control projects found. Create your first project to get started.</p>
                </td>
              </tr>
            </tbody>
          </table>
