  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-slate-400">Analyze trends and predict future quality and compliance issues</p>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-eqms-border">
                <th className="text-left py-3 px-4 font-semibold text-slate-300">Analysis ID</th>
                ...
                <th className="text-left py-3 px-4 font-semibold text-slate-300">Confidence</th>
            ...
            <tbody>
              <tr className="border-b border-eqms-border hover:bg-eqms-input transition-colors">
                <td colSpan="6" className="py-12 px-4 text-center">
                  ...
                  <p className="text-slate-500">No analyses found. Create your first predictive analysis to get started.</p>
                </td>
              </tr>
            </tbody>
          </table>
