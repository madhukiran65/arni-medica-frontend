...
export default function Recalls() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Recall Management</h1>
        <p className="text-slate-400">Manage product recalls, coordinating notification and corrective actions</p>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-eqms-border">
                <th className="text-left py-3 px-4 font-semibold text-slate-300">Recall ID</th>
            ...
            <tbody>
              <tr className="border-b border-eqms-border hover:bg-eqms-input transition-colors">
                <td colSpan="6" className="py-12 px-4 text-center">
                  ...
                  <p className="text-slate-500">No recalls found. Create your first record to get started.</p>
                </td>
              </tr>
            </tbody>
          </table>
