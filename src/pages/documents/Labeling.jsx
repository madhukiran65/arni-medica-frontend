...
import { Plus, Search, Filter, Barcode, Download } from 'lucide-react'
...
export default function Labeling() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Labels & IFU Management</h1>
        <p className="text-slate-400">Manage product labels, instructions for use, and regulatory labeling requirements</p>
      </div>
      ...
      <div className="card p-6">
        <div className="flex gap-4 mb-6">
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              placeholder="Search labels and IFU..."
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-eqms-border">
                <th className="text-left py-3 px-4 font-semibold text-slate-300">Label ID</th>
            ...
            <tbody>
              <tr className="border-b border-eqms-border hover:bg-eqms-input transition-colors">
                <td colSpan="6" className="py-12 px-4 text-center">
                  ...
                  <p className="text-slate-500">No labels found. Create your first label to get started.</p>
                </td>
              </tr>
            </tbody>
          </table>
