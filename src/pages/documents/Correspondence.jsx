...
export default function Correspondence() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Correspondence Management</h1>
        <p className="text-slate-400">Track regulatory correspondence, inquiries, and communications</p>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-eqms-border">
                <th className="text-left py-3 px-4 font-semibold text-slate-300">Reference ID</th>
                <th className="text-left py-3 px-4 font-semibold text-slate-300">Subject</th>
                <th className="text-left py-3 px-4 font-semibold text-slate-300">Recipient</th>
            ...
            <tbody>
              <tr className="border-b border-eqms-border hover:bg-eqms-input transition-colors">
                <td colSpan="6" className="py-12 px-4 text-center">
                  ...
                  <p className="text-slate-500">No correspondence found. Add your first message to get started.</p>
                </td>
              </tr>
            </tbody>
          </table>
